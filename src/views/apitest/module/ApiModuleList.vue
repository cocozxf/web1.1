<template>
  ...
  <el-form ref="searchFormRef" :inline="true" :model="searchForm" class="demo-form-inline">
    <el-form-item label="模块名称">
      <el-input v-model="searchForm.module_name" placeholder="根据模块名称筛选" clearable/>
    </el-form-item>
...
import { queryByPage, deleteData } from './ApiModule.js'; // 不同页面不同的接口
...
const searchForm = reactive({ "module_name": "", "project_id": "" });
...
const tableData = ref([]);
// 缓存系统 
// const projectNameCache = reactive({})


// const updateProjectName = (id) => {
//   if (!id || projectNameCache[id]) return
//   projectList.value.forEach(item => {
//     projectNameCache[id] = item.project_name
//   })
  // projectNameCache[id] = 'loading...'
  // queryById(id)
  //   .then(res => {
  //     projectNameCache[id] = res.data.data.project_name 
  //   })
  //   .catch(() => {
  //     projectNameCache[id] = '未知项目'
  //   })
// }
...
//   newVal.forEach(item => {
//     updateProjectName(item.project_id)
//   })
...
//     project_name: projectNameCache[item.project_id]
//   }))
// })
...
// import { queryById } from "../project/ApiProject.js"

// const getProjectname = (id) => {
//   return queryById(id).then((res) => {
//     const projectname = res.data.data.project_name;
//     return projectname
//   });
// }
// 加载页面数据
